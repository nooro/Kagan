...
bool Map::OnHover(SDL_Renderer* Rend, Camera* cam)
{
    ...
    SDL_SetTextureAlphaMod(Hover_Image, 200);
    ...
    SDL_SetTextureColorMod(Hover_Image, 237, 28, 36);
    SDL_SetTextureAlphaMod(Hover_Image, 50);

    Game::Draw(Rend, cam, Hover_Image,
               hoverTile->xCoord * cam->camZoom, hoverTile->yCoord * cam->camZoom, TILE_WIDTH, TILE_HEIGHT,
               hoverTile->tileSetCoordX * TILE_WIDTH, hoverTile->tileSetCoordY * TILE_HEIGHT, TILE_WIDTH, TILE_HEIGHT, hoverTile->angle, SDL_FLIP_NONE);
